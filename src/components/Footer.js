      ...
      <MDBContainer fluid className="text-center text-md-left" style = {{padding:"16px", fontFamily: "Century Gothic"}}>
        <MDBRow className = "d-flex justify-content-around">
          ...
          <MDBCol md="3" className="text-center" style = {{lineHeight: "1.6"}}>
            ...
            <div>
            <a href="https://www.un.org/en/" target="_blank" rel="noopener noreferrer" style = {{fontSize: "12px", letterSpacing: "1.5px"}}>
            ...
            <br />
            <a href="https://www.un.org/en/" target="_blank" rel="noopener noreferrer" style = {{fontSize: "12px", letterSpacing: "1.5px"}}>United Nations</a>
            <br /> <br />
            <a href="https://www.unicef.org/" target="_blank" rel="noopener noreferrer" style = {{fontSize: "12px", letterSpacing: "1.5px"}}>
            ...
            <br/>
            <a href="https://www.unicef.org/" target="_blank" rel="noopener noreferrer" style = {{fontSize: "12px", letterSpacing: "1.5px"}}>UNHCR</a>
            </div>
          </MDBCol>
        </MDBRow>
      </MDBContainer>
